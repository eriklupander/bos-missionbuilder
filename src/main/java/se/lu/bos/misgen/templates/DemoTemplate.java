...
public class DemoTemplate {
    ...
    public static String buildDemoMission() throws IOException {
        ...
        ObjectGroup planeGroup1 = GroupFactory.buildPlaneGroup(true, 3, PlaneType.BF109G2, true, 95939f, 500f, 50383f);
        ...
        ObjectGroup planeGroup2 = GroupFactory.buildPlaneGroup(false, 4, PlaneType.BF109G2, true, 94939f, 700f, 50383f);     // TODO Add skill, -1 for random?
        ObjectGroup yakGroup3 = GroupFactory.buildPlaneGroup(false, 4, PlaneType.YAK1, true, 96939f, 100f, 50383f);
        ObjectGroup il2Group3 = GroupFactory.buildPlaneGroup(false, 12, PlaneType.IL2M42, true, 96939f, 500f, 55383f);
